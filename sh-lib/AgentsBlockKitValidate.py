...
# Block Kit top-level type validator for DistroAgentsTools.fn.sh's --member-comms-slack-send-message
# --format blocks path (myx.distro-agents/sh-scripts/DistroAgentsTools.fn.sh).
