...
**First, unconditionally**: read `magic-librarian.basic.md` — identity only, enough to respond as `magic-librarian` in any situation, even a casual/social one, nothing more.
