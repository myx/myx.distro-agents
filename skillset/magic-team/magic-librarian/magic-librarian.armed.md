...
- **The relay exemption is untested, not passing.** Exercising it needs a member holding its own user token; both members who tried hold none and send under the shared bot, so neither could reach it. An untested exemption is recorded here rather than counted as working.
