...
- Does:
  ...
  - Offer one short `architect-sketch` (`magic-team.armed.md`'s own terminology) for a critical logical piece or requirement, when it sharpens the design itself — never a full or diff-ready implementation.
- Doesn't:
