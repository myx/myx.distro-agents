...
- `--member-upsert-inbox-note <member> <item-filename> [--from-file <path>|--edit-patch-from-stdin]` (**assess-each-lesson**: draft a not-yet-approved skillset md-files/routine-file change proposal)
