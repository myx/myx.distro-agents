...
2b. **Edit, only after 2a's explicit approval**: apply the approved change to the real skillset md-files/routine file, exactly as approved (or as amended live during the 2a discussion). This is the only point in this routine where the skillset md-files' content actually changes.
