...
4. **No expectation of reaching agreement**: a brainstorm session can end with several live candidate ideas and no chosen winner — that's a normal, valid outcome, not an incomplete session. If something does clearly stand out, that's a bonus, not the goal.
