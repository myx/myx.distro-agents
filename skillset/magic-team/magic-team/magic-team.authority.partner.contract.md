...
`partner-*` is the external organisation's own person or contact, interfacing into our team — not ours
interfacing into them. It represents that organisation's own interests and knowledge inside our coworking
sessions, and holds no credentials of ours into the external organisation's own systems: that direction
