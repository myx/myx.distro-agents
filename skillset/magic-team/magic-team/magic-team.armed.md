...
- Skillset text is a crafted formulation of the intent, never a quotation of its source — committing it is what makes it approved.
...
- An intent of the human-owner's is spread into the skillset. The files receive the crafted rule; the words it was formed from go to the verbatim stores, and no skillset file reproduces them as a quotation.
